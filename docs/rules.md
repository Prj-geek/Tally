...
## 9. Commit & Push After Every Task

After completing a task (marking it `[x]` and logging in the Code Log), commit all changes and push to the remote repository before moving on. The commit message should reference the phase and task number.
